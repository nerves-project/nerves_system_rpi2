...
This is a major update of `nerves_system_rpi2` that changes the MicroSD/eMMC
...
* Enhancements
  * The Raspberry Pi Touchscreen drivers are included by default now so that its
    possible to use Scenic without any changes to the system.
