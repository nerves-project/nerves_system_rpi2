# Raspberry Pi 2 Test Suite

Executes ExUnit tests on target hardware and reports results to the
[Nerves test server](https://nerves-test-server.herokuapp.com/nerves-project/nerves_system_rpi2)
...
The Raspberry Pi 2 uses `eth0` to connect to the report server and requires a
